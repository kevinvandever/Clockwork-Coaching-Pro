...
const HeroSection: React.FC = () => {
  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/5 to-neutral/5 px-4 md:px-8">
      ...
      <div className="container mx-auto pt-16">
        <div className="text-center">
          <h1 className="text-4xl md:text-6xl font-display font-medium mb-6 text-neutral-900 leading-tight">
